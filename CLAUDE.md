...
- **Precios (estrategia 2026-07-17)**: precio de lista (ancla) $129 USD / $1,999 MXN mostrado tachado en la landing; escalera de lanzamiento $29 (early, vigente) → $49 (~10 ventas) → $79 (~25 ventas), la ejecuta Vero editando los payment links en Stripe (URLs `buy.stripe.com` se conservan). Correcciones: 1 ronda gratis incluida + $6 USD / $59 MXN cada ronda adicional (payment links de corrección los crea Vero). Detalle en `docs/MYGUEST_OPERATIONS_RUNBOOK.md`.
