...
- **MyGuest 07**: landing multi-moneda cerrada (commit `483b8b2`; promo actualizada a from $49 USD / MXN $899 / CAD $69).
- **Precios (estrategia 2026-07-17)**: precio de lista (ancla) $129 USD / $1,999 MXN mostrado tachado en la landing; promo vigente $49 USD / $899 MXN / $69 CAD; escalera de lanzamiento $49 (actual) → $79 (~25 ventas), la ejecuta Vero editando los payment links en Stripe (URLs `buy.stripe.com` se conservan). Correcciones: 1 ronda gratis incluida + $6 USD / $59 MXN cada ronda adicional (payment links de corrección los crea Vero). Detalle en `docs/MYGUEST_OPERATIONS_RUNBOOK.md`.
